...
//Generating CAPTCHA
$image = imagecreatefromjpeg("app-assets/images/B.jpg");
$foreground = imagecolorallocate($image, 200, 280, 200); //font color
imagestring($image, 5, 45, 10, $captchanumber, $foreground);
