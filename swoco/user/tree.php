...
<div class="tree" style="width:6000;" >
<ul>
<?php
...
<a target="_parent"  data-container="body" data-toggle="collapse" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree['name']; ?><br><b>Email:</b> <?php echo $row_tree['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result1['token']); ?><br><b>Date of Joining:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree['date'])); ?></div>">
...
?>
<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_2['name']; ?><br><b>Email:</b> <?php echo $row_tree_2['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_2['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount1);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result11['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_2['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_3 = $total_income_amnt_3a;
	...
	<li>
<a target="_parent" data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_3['name']; ?><br><b>Email:</b> <?php echo $row_tree_3['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_3['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount2);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result12['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_3['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_4 = $total_income_amnt_4a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_4['name']; ?><br><b>Email:</b> <?php echo $row_tree_4['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_4['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount3);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result13['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_4['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_5 = $total_income_amnt_5a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_5['name']; ?><br><b>Email:</b> <?php echo $row_tree_5['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_4['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount4);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result14['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_5['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_6 = $total_income_amnt_6a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_6['name']; ?><br><b>Email:</b> <?php echo $row_tree_6['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_6['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount5);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result15['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_6['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_7 = $total_income_amnt_7a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_7['name']; ?><br><b>Email:</b> <?php echo $row_tree_7['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_7['link_reference_id'];?><br><b>Level Income:</b> $<?php echo $total_income_amnt_7;?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount6);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result16['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_7['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_8 = $total_income_amnt_8a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_8['name']; ?><br><b>Email:</b> <?php echo $row_tree_8['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_8['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount7);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result17['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_8['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
$total_income_amnt_9 = $total_income_amnt_9a;
	...
	<li>
<a target="_parent"  data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_9['name']; ?><br><b>Email:</b> <?php echo $row_tree_9['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_9['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount8);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result18['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_9['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
...
?>
	...
	<li>
<a target="_parent" data-container="body" data-toggle="popover" data-html="true" data-content="<div><b>Name:</b> <?php echo $row_tree_10['name']; ?><br><b>Email:</b> <?php echo $row_tree_10['email']; ?><br><b>Link Referece Id:</b> <?php echo $row_tree_10['link_reference_id'];?><br><b>Total Purchase Amount:</b> <?php echo floor($total_amount9);?><br><b>Total Purchase Token Qunatity:</b> <?php echo floor($query_ref_amt_result19['token']); ?><br><b>Joining Date:</b> <?php echo date('F d Y h:i:s', strtotime($row_tree_10['date'])); ?></div>">
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
