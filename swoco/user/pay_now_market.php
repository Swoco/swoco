...
{
	header('location:buy_sell_token.php');
}
...
<input type="hidden" name="item_name" value="<?php echo $inv_item_name; ?>">
<input type="hidden" name="item_description" value="<?php echo $order_id; ?>">
