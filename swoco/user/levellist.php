...
session_start();
 ...
 //include('income_level.php');
if($_SESSION['user_id'] == '')
{
    header('location:index.php');
}

/*if(isset($_GET['levelp']) && $_GET['levelp'] != '')
{
 $level_num = $_GET['levelp'];
 $level_ref_id = $_GET['levelp'];
 $ur_ref_id = $_GET['ref_id'];
}
else
{*/
...
$query = mysqli_query($con, "SELECT * FROM `milkyway_usersignup` WHERE `link_reference_id`= '".$ur_ref_id."'  ORDER BY id ASC");
                  ...
                  <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered file-export" style="font-family:Times New Roman;">
                       <thead>
                            ...
                            <?php
                              $cnt = 1;
                            $select_tree_2 = mysqli_query($con, "select * from milkyway_usersignup where link_reference_id='".$ur_ref_id."'");
