<?php include('inc/header.php');?>
  <div class="app-content content">
    <div class="sidebar-left sidebar-fixed ps-container ps-theme-dark ps-active-y" data-ps-id="3a45c1f4-43b7-e7b8-56c2-48aefa6ded74">
      <div class="sidebar">
          ...
          <div id="users-list" class="list-group position-relative">
            <div class="users-list-padding media-list">
              ...
              <a href="#" class="media border-0">
                <div class="media-left pr-1">
                  <span class="avatar avatar-md avatar-online">
                    <img class="media-object rounded-circle" src="app-assets/images/portrait/small/avatar-s-14.png" alt="Generic placeholder image">
                    <i></i>
                  </span>
                </div>
                <div class="media-body w-100">
    ...
    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 662px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 429px;"></div></div></div>
