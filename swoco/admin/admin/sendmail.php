...
$mail->CharSet = 'utf-8';  
$mail->SMTPDebug  = 0;   
$mail->Subject = 'Swoco Wallet Download';

// get email addresses from db based on checkboxes posted to us
$query = "select * from milkyway_usersignup";
...
">
                        <tr>
                            <td style="
           background-color: #0ac3f5;
       border: 1px solid #e472d2;
...
">
   ...
   text-align: center; 
    ...
    color: #333333;
    padding: 0px 10px;
    margin: 10px 0px 0px 0px;"><a href="" style=" color: #0ab3ef; text-decoration:none;">
 ...
 <p style="font-size: 14px;
	...
	text-align:center;
    padding: 0px 10px;
    margin: 10px 0px 0px 0px;"><a href="" style="color: #000000; text-decoration:none;">
    ...
    color: #000000;
    padding: 0px 10px;
    margin: 10px 0px 0px 0px; ">Best Regards<br>
...
<a href="https://swoco.io/#mobile-wallet" style="font-size: 14px;
    display:inline-block;
    line-height: 22px;
    color: #333333;
    padding: 0px 10px;
    margin: 10px 0px 0px 0px; color:white; ">
	<img src="https://www.swoco.io/swoco/admin/app-assets/images/6.jpg" style="box-shadow: 10px 10px 10px #0000002b;">
...
<a href="https://www.swoco.io/#services" style="font-size: 14px;
    ...
    padding: 0px 10px;
    margin: 10px 0px 0px 0px; color:white; ">
	<img src="https://www.swoco.io/swoco/admin/app-assets/images/5.jpg" style="box-shadow: 10px 10px 10px #0000002b;">
...
echo ($mail->Send()) ? "Message sent to: " : "Message <b>not</b> sent to: ";
    print $data["email"]."<br />\n";
