                   ...
                   <h1>Level 1</h1>
                    <table class="table table-striped table-bordered file-export" style="font-family:Times New Roman;">
                       <thead>
                            ...
                            <?php
                              $cnt = 1;
                            $select_tree_2 = mysqli_query($con, "select * from milkyway_usersignup where link_reference_id='".$_GET['sr']."'");
...
$rf_id_gt = $row['reference_id'];
                                ...
                                <td><a href="downline-levellist.php?id=<?php echo $row_tree_2['reference_id'];?>" target="_blank">View Downline </a></td>
...
?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_3['reference_id'];?>" target="_blank">View Downline </a></td>
...
$total_income_amnt_4 = $total_income_amnt_4a;
	...
	?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_4['reference_id'];?>" target="_blank">View Downline </a></td>
...
$total_income_amnt_6 = $total_income_amnt_6a;
	...
	?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_6['reference_id'];?>" target="_blank">View Downline </a></td>
...
$total_income_amnt_7 = $total_income_amnt_7a;
	...
	?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_7['reference_id'];?>" target="_blank">View Downline </a></td>
...
$total_income_amnt_8 = $total_income_amnt_8a;
	...
	?>                      
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_8['reference_id'];?>" target="_blank">View Downline </a></td>
...
$total_income_amnt_9 = $total_income_amnt_9a;
	...
	?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_9['reference_id'];?>" target="_blank">View Downline </a></td>
...
?>
                               ...
                               <td><a href="downline-levellist.php?id=<?php echo $row_tree_10['reference_id'];?>" target="_blank">View Downline </a></td>
