              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard" style="text-align: right;">
                                 <div style="display: inline-block;">  Search Downline: <input type="text" id="search" /></div>
...
$(function(){
   ...
   $('span.k-in > span.highlight').each(function(){
    ...
    $('.tree ul li a span').each(function(){
        var text = $(this).text();
        var p = text.toUpperCase().indexOf(term);
        if (p >= 0) {
            var s1='', s2='';
       // $('.tree ul li a span').addClass('highlight');
...
//   if (val) {
//     //   // $('.tree ul li a span').addClass('highlight');
//     // $('.tree ul li a span').each(function(val, obj){
...
//   }
//   else
//     $('.tree ul li a span').removeClass('highlight')
// })
})
</script>
...
div{
	...
	<div class="tree" style="width:6000;" id="tree1">
...
$select_tree = mysqli_query($con, "select * from milkyway_usersignup where reference_id='02563286649209'");
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_2['reference_id']; ?></span>
</a>
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_3['reference_id']; ?></span>
</a>
<ul>
	<?php
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_4['reference_id']; ?></span>
</a>
<ul>
	<?php
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_5['reference_id']; ?></span>
</a>
<ul>
	<?php
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_6['reference_id']; ?></span>
</a>
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_7['reference_id']; ?></span>
</a>
<ul>
	<?php
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_8['reference_id']; ?></span>
</a>
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_9['reference_id']; ?></span>
</a>
<ul>
	<?php
...
<img src="app-assets/images/no-image.jpg" height="100px;"><br>
<span>Ref id: <?php echo $row_tree_10['reference_id']; ?></span>
</a>
</li>
<?php } ?>
</ul>
